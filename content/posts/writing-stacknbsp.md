...
## Bear
[Bear](https://bearapp.com) is a Markdown-based editor bound to the Apple ecosystem. Each document is a plain page for text, and you don't need to fiddle with content blocks or different modules while you write. For me, Bear is special for five reasons. 
...
## Ulysses
[Ulysses](https://ulyssesapp.com) is where the more significant work gets done. Pretty much anything that becomes public-facing gets sent through Ulysses. I may write an initial blog draft in Bear, but it always lands in a categorized folder in Ulysses before posting. 
...
## Grammarly 
Anything I write is run through [Grammarly](https://grammarly.com). Ulysses has some decent language and proofing tools, but in my experience, Grammarly is best-in-class at making sure you sound at least somewhat articulate. In the editing phase, I'll pass a whole draft or chapter through Grammarly to clean up the most egregious mistakes. 

## Hemingway Editor
I'm a big advocate for writing short and direct, especially for marketing copy. [Hemingway Editor](https://hemingwayapp.com) helps with just that. Depending on the piece's intent, I don't take every suggestion and edit for gospel, but the app always helps drill to the heart of the matter. 

## Notion
Before Bear, there was [Notion](https://notion.so). I love the concept of Notion but found that it's not the place for me to get writing done. It is a great place to store data in tables. My D&D campaign wiki and recaps live here and directly shared with players. I also use Notion for my Editorial Calendar. 
...
[ReMarkable](https//remarkable.com) recently moved to a dubious subscription model that gates basic functionality behind an $8 per month paywall, so it's hard to recommend the tablet. However, it still is quite good at what it does. 
